...
async function seedBackdoorMockData(
  ...
  const courses = [
    ...
    {
      title: "Carbine 1 — Zero, Manipulation, Movement",
      description:
        "One-day AR-15 fundamentals: zeroing at 50/200, reloads, malfunction clearing, shooting on the move. Round count ~400. Bring rifle, sling, 3 mags, eye/ear pro.",
      category: "Firearms",
      primary_pillar: "firearms",
      secondary_pillar: "tactics",
      price_cents: 34900,
      duration_minutes: 480,
      capacity: 18,
      location_name: "Lone Star Tactical Range",
      address: "4501 FM 973",
      city: "Austin",
      state: "TX",
      lat: 30.1903,
      ...
      ends_at: new Date(now + 10 * day + 8 * 3600 * 1000).toISOString(),
      cover_image_url: cover("photo-1584555613497-9ecf9dd06f68"),
    },
    {
      title: "Concealed Carry — Drawing from Concealment",
      description:
      ...
      capacity: 14,
      location_name: "Red's Indoor Range",
      address: "10515 N FM 620",
      city: "Austin",
      state: "TX",
      lat: 30.4615,
      lng: -97.8067,
      ...
      starts_at: new Date(now + 14 * day).toISOString(),
      ends_at: new Date(now + 14 * day + 4 * 3600 * 1000).toISOString(),
      cover_image_url: cover("photo-1595590424283-b8f17842773f"),
    },
    {
      title: "Vehicle CQB — Fighting In & Around Cars",
      description:
        "Use of cover, shooting through windshields, exits under fire, and weapon transitions around vehicles. Sim rounds + live fire blocks.",
      category: "CQB",
      primary_pillar: "tactics",
      secondary_pillar: "firearms",
      price_cents: 54900,
      ...
      capacity: 12,
      location_name: "Centex Shoothouse",
      address: "5500 W US Hwy 290",
      city: "Dripping Springs",
      state: "TX",
      lat: 30.1902,
      lng: -98.0867,
      skill_level: "advanced",
      starts_at: new Date(now + 18 * day).toISOString(),
      ends_at: new Date(now + 18 * day + 9 * 3600 * 1000).toISOString(),
      cover_image_url: cover("photo-1517400508447-f8dd518b86db"),
    },
    {
      title: "Stop The Bleed — Civilian Trauma Basics",
      description:
        "Two-hour Stop The Bleed certified course. Tourniquets, pressure, wound packing. Great for teachers, parents, and EDC carriers.",
      category: "Medical",
      primary_pillar: "medical",
      secondary_pillar: null,
      price_cents: 8900,
      ...
      capacity: 24,
      location_name: "Round Rock Community Center",
      address: "2003 Town Center Dr",
      city: "Round Rock",
      state: "TX",
      lat: 30.5083,
      lng: -97.6789,
      ...
      ends_at: new Date(now + 5 * day + 2 * 3600 * 1000).toISOString(),
      cover_image_url: cover("photo-1530026405186-ed1f139313f8"),
    },
    {
      title: "Edged Weapon Defense — Empty Hand vs Knife",
      description:
      ...
      duration_minutes: 240,
      capacity: 20,
      location_name: "ATX Combatives Gym",
      address: "1200 E Cesar Chavez St",
      city: "Austin",
      state: "TX",
      lat: 30.2598,
      lng: -97.7322,
      ...
      ends_at: new Date(now + 12 * day + 4 * 3600 * 1000).toISOString(),
      cover_image_url: cover("photo-1554189097-ffe88e998a2b"),
    },
    {
      title: "Land Navigation — Map, Compass, Terrain",
      description:
        "Full-day land nav in Hill Country: pace count, terrain association, route planning, and night nav block. Bring boots and a headlamp.",
      category: "Tactics",
      primary_pillar: "tactics",
      secondary_pillar: "fieldcraft",
      price_cents: 19900,
      duration_minutes: 600,
      capacity: 16,
      ...
      lng: -98.2517,
      skill_level: "beginner",
      starts_at: new Date(now + 24 * day).toISOString(),
      ends_at: new Date(now + 24 * day + 10 * 3600 * 1000).toISOString(),
      cover_image_url: cover("photo-1502780402662-acc01917cf2b"),
    },
    {
      title: "Precision Rifle 101 — 100 to 600 Yards",
      description:
        "Bolt-gun fundamentals: zero verification, dope cards, wind calls, and positional shooting to 600y. Bring rifle, 80 rounds, bipod.",
      category: "Firearms",
      primary_pillar: "firearms",
      secondary_pillar: "tactics",
      price_cents: 44900,
      duration_minutes: 480,
      capacity: 10,
      location_name: "Brady Long Range",
      address: "FM 2028",
      city: "Brady",
      state: "TX",
      lat: 31.1357,
      ...
      ends_at: new Date(now + 30 * day + 8 * 3600 * 1000).toISOString(),
      cover_image_url: cover("photo-1595590424283-b8f17842773f"),
    },
    {
      title: "Women's Defensive Pistol Clinic",
      description:
      ...
      duration_minutes: 240,
      capacity: 12,
      location_name: "Shoot Smart Range",
      address: "8511 Tonkawa Trail",
      city: "Fort Worth",
      state: "TX",
      lat: 32.7555,
      lng: -97.3308,
      skill_level: "beginner",
      starts_at: new Date(now + 16 * day).toISOString(),
      ends_at: new Date(now + 16 * day + 4 * 3600 * 1000).toISOString(),
      cover_image_url: cover("photo-1595590424283-b8f17842773f"),
    },
    {
      title: "Force-on-Force Scenario Lab",
      description:
      ...
      duration_minutes: 540,
      capacity: 12,
      location_name: "Reed Tactical Shoothouse",
      address: "12450 Range Rd",
      city: "Austin",
      state: "TX",
      lat: 30.2972,
      lng: -97.7031,
      skill_level: "advanced",
      starts_at: new Date(now + 28 * day).toISOString(),
      ends_at: new Date(now + 28 * day + 9 * 3600 * 1000).toISOString(),
      cover_image_url: cover("photo-1517400508447-f8dd518b86db"),
    },
    {
      title: "Wilderness First Aid Weekend",
      description:
        "Two-day WFA course covering remote-environment trauma, environmental injuries, evacuation planning, and improvised splinting.",
      category: "Medical",
      primary_pillar: "medical",
      secondary_pillar: "fieldcraft",
      price_cents: 32900,
      ...
      address: "3630 Park Rd 4 W",
      city: "Burnet",
      state: "TX",
      lat: 30.7335,
      lng: -98.3700,
      skill_level: "all_levels",
      starts_at: new Date(now + 35 * day).toISOString(),
      ends_at: new Date(now + 35 * day + 16 * 3600 * 1000).toISOString(),
      cover_image_url: cover("photo-1530026405186-ed1f139313f8"),
    },
    // ---- Multi-state coverage so SEO landing pages aren't thin ----
    {
      ...
      skill_level: "beginner",
      starts_at: new Date(now + 8 * day).toISOString(),
      ends_at: new Date(now + 8 * day + 6 * 3600 * 1000).toISOString(),
      cover_image_url: cover("photo-1595590424283-b8f17842773f"),
    },
    {
      title: "Arizona Desert Carbine Clinic",
      description: "Carbine work in open desert terrain — positional shooting, barricade use, and 25–300 yard transitions.",
      category: "Firearms", primary_pillar: "firearms", secondary_pillar: "tactics",
      price_cents: 32900, duration_minutes: 480, capacity: 14,
      location_name: "Cowtown Range", address: "10402 W Carefree Hwy",
      city: "Peoria", state: "AZ", lat: 33.8023, lng: -112.2876,
      skill_level: "intermediate",
      starts_at: new Date(now + 11 * day).toISOString(),
      ends_at: new Date(now + 11 * day + 8 * 3600 * 1000).toISOString(),
      cover_image_url: cover("photo-1584555613497-9ecf9dd06f68"),
    },
    {
      title: "Nevada High-Round-Count Pistol",
      description: "1,000-round pistol skills weekend in the Mojave. Diagnostics, drills, and competition-style stages.",
      category: "Firearms", primary_pillar: "firearms", secondary_pillar: "tactics",
      price_cents: 54900, duration_minutes: 960, capacity: 16,
      location_name: "Pro Gun Vegas", address: "12801 US-95",
      city: "Boulder City", state: "NV", lat: 35.9322, lng: -114.8519,
      skill_level: "advanced",
      starts_at: new Date(now + 22 * day).toISOString(),
      ends_at: new Date(now + 22 * day + 16 * 3600 * 1000).toISOString(),
      cover_image_url: cover("photo-1517400508447-f8dd518b86db"),
    },
    {
      ...
      ends_at: new Date(now + 9 * day + 5 * 3600 * 1000).toISOString(),
      cover_image_url: cover("photo-1554189097-ffe88e998a2b"),
    },
    {
      title: "North Carolina Precision Rifle Match Prep",
      description: "PRS-style positional rifle training — barricades, tank traps, and wind reading out to 800 yards.",
      category: "Firearms", primary_pillar: "firearms", secondary_pillar: "tactics",
      price_cents: 49900, duration_minutes: 600, capacity: 10,
      location_name: "Rockcastle Shooting Center", address: "200 Range Rd",
      city: "Park City", state: "NC", lat: 35.5174, lng: -80.6201,
      skill_level: "intermediate",
      starts_at: new Date(now + 26 * day).toISOString(),
      ends_at: new Date(now + 26 * day + 10 * 3600 * 1000).toISOString(),
      cover_image_url: cover("photo-1595590424283-b8f17842773f"),
    },
    {
      title: "Pennsylvania Stop The Bleed",
      description: "Two-hour Stop The Bleed certified course for Pittsburgh-area parents, teachers, and EDC carriers.",
      category: "Medical", primary_pillar: "medical", secondary_pillar: null,
      price_cents: 8900, duration_minutes: 120, capacity: 24,
      location_name: "Pittsburgh Tactical", address: "5 Allegheny Center",
      city: "Pittsburgh", state: "PA", lat: 40.4515, lng: -80.0066,
      skill_level: "beginner",
      starts_at: new Date(now + 6 * day).toISOString(),
      ends_at: new Date(now + 6 * day + 2 * 3600 * 1000).toISOString(),
      cover_image_url: cover("photo-1530026405186-ed1f139313f8"),
    },
    {
      ...
      skill_level: "beginner",
      starts_at: new Date(now + 13 * day).toISOString(),
      ends_at: new Date(now + 13 * day + 6 * 3600 * 1000).toISOString(),
      cover_image_url: cover("photo-1595590424283-b8f17842773f"),
    },
    {
      title: "Colorado Mountain Land Nav",
      description: "Alpine land navigation: terrain association, route planning, and altitude considerations. Bring layers.",
      category: "Tactics", primary_pillar: "tactics", secondary_pillar: "fieldcraft",
      price_cents: 21900, duration_minutes: 600, capacity: 14,
      location_name: "Pike National Forest", address: "Rampart Range Rd",
      city: "Colorado Springs", state: "CO", lat: 38.9486, lng: -104.9719,
      skill_level: "intermediate",
      starts_at: new Date(now + 20 * day).toISOString(),
      ends_at: new Date(now + 20 * day + 10 * 3600 * 1000).toISOString(),
      cover_image_url: cover("photo-1502780402662-acc01917cf2b"),
    },
    {
      ...
      skill_level: "beginner",
      starts_at: new Date(now + 15 * day).toISOString(),
      ends_at: new Date(now + 15 * day + 4 * 3600 * 1000).toISOString(),
      cover_image_url: cover("photo-1554189097-ffe88e998a2b"),
    },
    {
      title: "Virginia Vehicle Defense Basics",
      description: "Working around vehicles: use of cover, exits under threat, and pistol presentations from the driver's seat.",
      category: "CQB", primary_pillar: "tactics", secondary_pillar: "firearms",
      price_cents: 34900, duration_minutes: 360, capacity: 12,
      location_name: "Echo Valley Training Center", address: "1078 Echo Ln",
      city: "High View", state: "VA", lat: 39.2840, lng: -78.4503,
      skill_level: "intermediate",
      starts_at: new Date(now + 17 * day).toISOString(),
      ends_at: new Date(now + 17 * day + 6 * 3600 * 1000).toISOString(),
      cover_image_url: cover("photo-1517400508447-f8dd518b86db"),
    },
  ];
